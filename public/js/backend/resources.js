...
function startResourceList() {
    getDataOverAJAX( 'getResourceList' ).then(
        function( data ) {
            renderResourceList( JSON.parse( data));
        }, function ( error ) {
            console.log( error );
        }
    );
...
function renderResourceList( data ) {
    ...
    function render(data) {
        ...
        $('li.files a').click(function (e) {
            e.preventDefault();
            var file = '<p>&nbsp;</p><p class="file">' + this.outerHTML + '</p><p>&nbsp;</p>';
            tinymce.get("contingut").execCommand('mceInsertContent', false, file);
        });
