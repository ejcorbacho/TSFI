...
@section('content')
  ...
  <!--DATA TABLES-->
  <script src="{{asset('js/backend/beTotesEntradesPaperera.js')}}"></script>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
              <div class="box-header with-border">
                  <h3 class="box-title">Paperera d'entrades</h3>
              </div>
              <!-- /.box-header -->
                  ...
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">×</span></button>
                              <h4 class="modal-title">Restaurar una entrada</h4>
                          </div>
                          ...
                          <div class="modal-footer">
                              <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancel·la</button>
                              <button type="button" class="btn btn-success botoEliminarEntradaIntern">Restaurar</button>
                          </div>
                      </div>
                  </div>
              </div>
              <div class="box-body no-padding">
                ...
                <!-- /.pull-right -->
                  ...
                  <tr entradaId="{{ $dato->id }}">
                      ...
                      <td><button type="button" class="btn btn-default btn-sm botoEsborrarEntrades"><i class="fa fa-window-restore"></i>Restaurar</button></td>
                  </tr>
                  @endforeach
                  </tbody>
                  </table>
